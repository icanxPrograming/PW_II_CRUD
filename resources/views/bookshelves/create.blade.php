    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="post" action="{{ route('bookshelves.store') }}" class="mt-6 space-y-6">
                    @csrf

                    <div class="max-w-xl">
                        <x-input-label for="code" value="Kode Rak"/>
                        <x-text-input id="code" type="text" name="code" class="mt-1 block w-full" value="{{ old('code') }}" required/>
